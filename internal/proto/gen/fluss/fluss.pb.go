...
type PbAlterConfig struct {
	...
	OpType        *int32                 `protobuf:"varint,3,req,name=op_type,json=opType" json:"op_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PbAddColumn struct {
	...
	ColumnPositionType *int32                 `protobuf:"varint,4,req,name=column_position_type,json=columnPositionType" json:"column_position_type,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type PbModifyColumn struct {
	...
	Comment            *string                `protobuf:"bytes,3,opt,name=comment" json:"comment,omitempty"`
	ColumnPositionType *int32                 `protobuf:"varint,4,opt,name=column_position_type,json=columnPositionType" json:"column_position_type,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
const file_fluss_proto_rawDesc = "" +
	...
	"\x0fremote_data_dir\x18\x03 \x01(\tR\rremoteDataDir\"j\n" +
	...
	"\x0fGetDatabaseInfo\x10\x8b\b\x12\x14\n" +
	"\x0fCreatePartition\x10\x8c\b\x12\x12\n" +
	"\rDropPartition\x10\x8d\b\x12\x11\n" +
	"\fAuthenticate\x10\x8e\b\x12\x0f\n" +
	"\n" +
	"CreateAcls\x10\x8f\b\x12\r\n" +
...
var file_fluss_proto_goTypes = []any{
	...
	(*AlterTableRequest)(nil),                  // 29: fluss.AlterTableRequest
	(*AlterTableResponse)(nil),                 // 30: fluss.AlterTableResponse
	(*DropTableRequest)(nil),                   // 31: fluss.DropTableRequest
	(*DropTableResponse)(nil),                  // 32: fluss.DropTableResponse
	(*GetTableInfoRequest)(nil),                // 33: fluss.GetTableInfoRequest
	(*GetTableInfoResponse)(nil),               // 34: fluss.GetTableInfoResponse
	(*ListTablesRequest)(nil),                  // 35: fluss.ListTablesRequest
	(*ListTablesResponse)(nil),                 // 36: fluss.ListTablesResponse
	(*TableExistsRequest)(nil),                 // 37: fluss.TableExistsRequest
	(*TableExistsResponse)(nil),                // 38: fluss.TableExistsResponse
	(*GetFileSystemSecurityTokenRequest)(nil),  // 39: fluss.GetFileSystemSecurityTokenRequest
	(*GetFileSystemSecurityTokenResponse)(nil), // 40: fluss.GetFileSystemSecurityTokenResponse
	(*PbKeyValue)(nil),                         // 41: fluss.PbKeyValue
	(*PbPartitionSpec)(nil),                    // 42: fluss.PbPartitionSpec
	(*ListPartitionInfosRequest)(nil),          // 43: fluss.ListPartitionInfosRequest
	(*PbPartitionInfo)(nil),                    // 44: fluss.PbPartitionInfo
	(*PbAlterConfig)(nil),                      // 45: fluss.PbAlterConfig
	(*PbAddColumn)(nil),                        // 46: fluss.PbAddColumn
