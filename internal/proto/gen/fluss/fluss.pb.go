...
var (
	ApiKey_name = map[int32]string{
		...
		1017: "Lookup",
		1021: "ListOffsets",
		1023: "GetLatestKvSnapshots",
		1024: "GetKvSnapshotMetadata",
		1032: "GetLakeSnapshot",
		1026: "InitWriter",
		1033: "LimitScan",
		1034: "PrefixLookup",
...
type GetLakeSnapshotRequest struct {
	...
	Readable      *bool                  `protobuf:"varint,3,opt,name=readable" json:"readable,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PbLakeSnapshotForBucket struct {
	...
	PartitionId   *int64                 `protobuf:"varint,1,opt,name=partition_id,json=partitionId" json:"partition_id,omitempty"`
	BucketId      *int32                 `protobuf:"varint,2,req,name=bucket_id,json=bucketId" json:"bucket_id,omitempty"`
	LogOffset     *int64                 `protobuf:"varint,3,req,name=log_offset,json=logOffset" json:"log_offset,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_fluss_proto_rawDesc = "" +
	...
	"isLogTable\x12\x18\n" +
	"\arecords\x18\x04 \x01(\fR\arecords\"w\n" +
	...
	"\x0esnapshot_files\x18\x02 \x03(\v2\x1f.fluss.PbRemotePathAndLocalFileR\rsnapshotFiles\"\x88\x01\n" +
	...
	"snapshotId\x12I\n" +
	"\x10bucket_snapshots\x18\x03 \x03(\v2\x1e.fluss.PbLakeSnapshotForBucketR\x0fbucketSnapshots\"\x85\x01\n" +
	...
	"\twriter_id\x18\x01 \x02(\x03R\bwriterId\"k\n" +
	"\fPbKvSnapshot\x12\x1b\n" +
	"\tbucket_id\x18\x01 \x02(\x05R\bbucketId\x12\x1f\n" +
	"\vsnapshot_id\x18\x02 \x01(\x03R\n" +
	"snapshotId\x12\x1d\n" +
	"\n" +
	"log_offset\x18\x03 \x01(\x03R\tlogOffset\"c\n" +
	"\x18PbRemotePathAndLocalFile\x12\x1f\n" +
	"\vremote_path\x18\x01 \x02(\tR\n" +
	"remotePath\x12&\n" +
	"\x0flocal_file_name\x18\x02 \x02(\tR\rlocalFileName\"x\n" +
	"\x17PbLakeSnapshotForBucket\x12!\n" +
	"\fpartition_id\x18\x01 \x01(\x03R\vpartitionId\x12\x1b\n" +
	"\tbucket_id\x18\x02 \x02(\x05R\bbucketId\x12\x1d\n" +
	"\n" +
	"log_offset\x18\x03 \x02(\x03R\tlogOffset\"G\n" +
	...
	"\tchallenge\x18\x01 \x01(\fR\tchallenge*\x85\x04\n" +
	"\x06ApiKey\x12\x10\n" +
	...
	"\vListOffsets\x10\xfd\a\x12\x19\n" +
	"\x14GetLatestKvSnapshots\x10\xff\a\x12\x1a\n" +
	"\x15GetKvSnapshotMetadata\x10\x80\b\x12\x14\n" +
	"\x0fGetLakeSnapshot\x10\x88\b\x12\x0f\n" +
	"\n" +
...
var file_fluss_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
var file_fluss_proto_goTypes = []any{
	...
	(*GetLatestKvSnapshotsRequest)(nil),        // 71: fluss.GetLatestKvSnapshotsRequest
	(*GetLatestKvSnapshotsResponse)(nil),       // 72: fluss.GetLatestKvSnapshotsResponse
	(*GetKvSnapshotMetadataRequest)(nil),       // 73: fluss.GetKvSnapshotMetadataRequest
	(*GetKvSnapshotMetadataResponse)(nil),      // 74: fluss.GetKvSnapshotMetadataResponse
	(*GetLakeSnapshotRequest)(nil),             // 75: fluss.GetLakeSnapshotRequest
	(*GetLakeSnapshotResponse)(nil),            // 76: fluss.GetLakeSnapshotResponse
	(*PbScanReqForBucket)(nil),                 // 77: fluss.PbScanReqForBucket
	(*ScanKvRequest)(nil),                      // 78: fluss.ScanKvRequest
	(*ScanKvResponse)(nil),                     // 79: fluss.ScanKvResponse
	(*InitWriterRequest)(nil),                  // 80: fluss.InitWriterRequest
	(*InitWriterResponse)(nil),                 // 81: fluss.InitWriterResponse
	(*PbKvSnapshot)(nil),                       // 82: fluss.PbKvSnapshot
	(*PbRemotePathAndLocalFile)(nil),           // 83: fluss.PbRemotePathAndLocalFile
	(*PbLakeSnapshotForBucket)(nil),            // 84: fluss.PbLakeSnapshotForBucket
	(*AuthenticateRequest)(nil),                // 85: fluss.AuthenticateRequest
	(*AuthenticateResponse)(nil),               // 86: fluss.AuthenticateResponse
}
var file_fluss_proto_depIdxs = []int32{
	...
	6,  // 36: fluss.GetLatestKvSnapshotsRequest.table_path:type_name -> fluss.PbTablePath
	82, // 37: fluss.GetLatestKvSnapshotsResponse.latest_snapshots:type_name -> fluss.PbKvSnapshot
	83, // 38: fluss.GetKvSnapshotMetadataResponse.snapshot_files:type_name -> fluss.PbRemotePathAndLocalFile
	6,  // 39: fluss.GetLakeSnapshotRequest.table_path:type_name -> fluss.PbTablePath
	84, // 40: fluss.GetLakeSnapshotResponse.bucket_snapshots:type_name -> fluss.PbLakeSnapshotForBucket
	77, // 41: fluss.ScanKvRequest.bucket_scan_req:type_name -> fluss.PbScanReqForBucket
	6,  // 42: fluss.InitWriterRequest.table_path:type_name -> fluss.PbTablePath
